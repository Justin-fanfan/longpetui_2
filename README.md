...
4. [外部系统边界](02-external/README.md)
5. [Remote Voice 数据流](03-flows/RemoteVoiceFlow.md)
6. [单核性能与推理调度](04-runtime/PerformanceAndInferenceScheduling.md)
7. [V0.1 → V1.0 路线](06-roadmap/VersionRoadmap.md)
